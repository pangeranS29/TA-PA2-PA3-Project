...
func (u *jadwalLayananUsecase) Create(data *models.JadwalLayanan, vaksinIDs []uint) error {
	return u.repo.Create(data, vaksinIDs)
}
...
func (u *jadwalLayananUsecase) Update(id int32, data *models.JadwalLayanan, vaksinIDs []uint) error {
	return u.repo.Update(id, data, vaksinIDs)
}
