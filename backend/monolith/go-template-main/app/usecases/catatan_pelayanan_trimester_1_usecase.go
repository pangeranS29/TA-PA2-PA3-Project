...
type CatatanPelayananTrimester1Usecase interface {
	...
	GetByID(id uint) (*models.CatatanPelayananTrimester1, error)
	GetByIbuID(ibuID uint) ([]models.CatatanPelayananTrimester1, error)
...
func (u *catatanPelayananTrimester1Usecase) GetByID(id uint) (*models.CatatanPelayananTrimester1, error) {
	return u.repo.FindByID(id)
}

func (u *catatanPelayananTrimester1Usecase) GetByIbuID(ibuID uint) ([]models.CatatanPelayananTrimester1, error) {
...
func (u *catatanPelayananTrimester1Usecase) Delete(id uint) error {
