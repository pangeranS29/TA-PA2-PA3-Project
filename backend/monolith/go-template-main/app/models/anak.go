...
type Anak struct {
	...
	Nama          string         `json:"nama" gorm:"not null;default:''"`
	TanggalLahir  time.Time      `json:"tanggal_lahir" gorm:"not null;default:CURRENT_TIMESTAMP"`
	JenisKelamin  string         `json:"jenis_kelamin" gorm:"not null;default:'Laki-Laki'"`
