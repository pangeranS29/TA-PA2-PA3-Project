...
type Anak struct {
	...
	BeratLahirKg  *float64       `json:"berat_lahir_kg,omitempty" gorm:"column:berat_lahir_kg"`
	TinggiLahirCm *float64       `json:"tinggi_lahir_cm,omitempty" gorm:"column:tinggi_lahir_cm"`
