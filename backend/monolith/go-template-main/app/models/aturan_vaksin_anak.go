...
type AturanVaksinAnak struct {
	...
	DosisSebelumID    *uint          `gorm:"column:id_dosis_sebelum" json:"dosis_sebelum_id,omitempty"`
	DosisVaksin   *DosisVaksin   `json:"dosis_vaksin,omitempty" gorm:"foreignKey:DosisVaksinID;constraint:OnDelete:CASCADE"`
	DosisSebelumRel *DosisVaksin   `json:"dosis_sebelum,omitempty" gorm:"foreignKey:DosisSebelumID;constraint:OnDelete:SET NULL"`
