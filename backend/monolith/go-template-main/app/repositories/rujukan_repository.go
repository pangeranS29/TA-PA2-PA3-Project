...
func (r *RujukanRepository) FindByID(id uint) (*models.Rujukan, error) {
	var rj models.Rujukan
	err := r.db.First(&rj, id).Error
	return &rj, err
}

func (r *RujukanRepository) FindByIbuID(ibuID uint) ([]models.Rujukan, error) {
...
func (r *RujukanRepository) Delete(id uint) error {
