...
func (r *CatatanPelayananTrimester1Repository) FindByID(id uint) (*models.CatatanPelayananTrimester1, error) {
	var c models.CatatanPelayananTrimester1
	err := r.db.First(&c, id).Error
	return &c, err
}

func (r *CatatanPelayananTrimester1Repository) FindByIbuID(ibuID uint) ([]models.CatatanPelayananTrimester1, error) {
...
func (r *CatatanPelayananTrimester1Repository) Delete(id uint) error {
