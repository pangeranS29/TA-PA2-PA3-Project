...
type IbuHamilController struct {
	usecase usecases.IbuHamilUsecase
}

func NewIbuHamilController(u usecases.IbuHamilUsecase) *IbuHamilController {
	return &IbuHamilController{usecase: u}
}

func (c *IbuHamilController) Create(ctx echo.Context) error {
	var req models.IbuHamil
...
func (c *IbuHamilController) GetByID(ctx echo.Context) error {
...
func (c *IbuHamilController) GetAll(ctx echo.Context) error {
...
func (c *IbuHamilController) Update(ctx echo.Context) error {
	id, err := strconv.ParseInt(ctx.Param("id"), 10, 32)
	if err != nil {
		return ctx.JSON(http.StatusBadRequest, models.Response{StatusCode: 400, Message: "invalid id"})
	}
...
func (c *IbuHamilController) Delete(ctx echo.Context) error {
	id, err := strconv.ParseInt(ctx.Param("id"), 10, 32)
	if err != nil {
		return ctx.JSON(http.StatusBadRequest, models.Response{StatusCode: 400, Message: "invalid id"})
	}
