      ...
      {items.map((item) => {
        ...
        return (
          <label
            ...
            className={`cursor-pointer select-none flex items-center gap-2 text-sm px-4 py-2 rounded-full border transition-all duration-300 ${isChecked ? "bg-indigo-600 text-white border-indigo-600 shadow-md shadow-indigo-200" : "bg-white text-gray-600 border-gray-200 hover:border-indigo-300 hover:bg-indigo-50"
              }`}
          >
          ...
          <div className="flex gap-4 mb-8">
            {["evaluasi", "riwayat"].map((tab) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${activeTab === tab ? "bg-indigo-600 text-white shadow-lg shadow-indigo-200 transform scale-105" : "bg-white text-gray-500 hover:bg-indigo-50 hover:text-indigo-600 border border-gray-200"
                  }`}
              >
            ...
            <form onSubmit={handleSubmitEvaluasi} className="space-y-8">
              ...
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50 p-8 transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                  {[
                    { name: "inspeksi_porsio", label: "Porsio" },
                    { name: "inspeksi_uretra", label: "Uretra" },
                    { name: "inspeksi_vagina", label: "Vagina" },
                    { name: "inspeksi_vulva", label: "Vulva" },
                    { name: "inspeksi_fluksus", label: "Fluksus" },
                    { name: "inspeksi_fluor", label: "Fluor" },
                  ].map((item) => (
