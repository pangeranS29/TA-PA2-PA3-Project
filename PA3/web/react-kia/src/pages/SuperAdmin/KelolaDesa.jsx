...
export default function KelolaDesa() {
    ...
    <tr>
        <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Nama Desa</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Kecamatan</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Kabupaten</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Provinsi</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Kode Desa</th>
            ...
            <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-sm text-slate-500">Dibuat {new Date(desa.created_at).toLocaleDateString("id-ID")}</div>
                    </div>
                </div>
            </td>
            <td className="px-6 py-4 text-slate-600">{desa.kecamatan}</td>
            <td className="px-6 py-4 text-slate-600">{desa.kabupaten}</td>
            <td className="px-6 py-4 text-slate-600">{desa.provinsi}</td>
            <td className="px-6 py-4 text-slate-700 font-medium">{desa.kode_desa}</td>
            <td className="px-6 py-4">
                <span
            ...
            <td className="px-6 py-4">
                <div className="flex items-center justify-center gap-2">
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-blue-700 hover:bg-blue-50 transition"
                    >
                        <Edit size={16} />
                        Edit
                    </button>
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-red-700 hover:bg-red-50 transition disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                        <Power size={16} />
                        Nonaktifkan
                    </button>
