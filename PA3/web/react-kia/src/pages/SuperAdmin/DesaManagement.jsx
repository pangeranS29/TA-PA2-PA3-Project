              ...
              <table className="w-full min-w-[1100px]">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Wilayah</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-slate-700">Kode</th>
