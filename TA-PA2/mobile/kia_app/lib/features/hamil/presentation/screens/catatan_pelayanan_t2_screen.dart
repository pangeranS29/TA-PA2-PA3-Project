...
import 'catatan_pelayanan_t2_detail_screen.dart';

class CatatanPelayananT2Screen extends StatefulWidget {
  const CatatanPelayananT2Screen({super.key});

  @override
  State<CatatanPelayananT2Screen> createState() => _CatatanPelayananT2ScreenState();
}
  ...
  Future<void> _loadCatatan() async {
    try {
      ...
      final response = await http.get(
        Uri.parse("http://localhost:8080/modul-ibu/catatan-pelayanan-t2?kehamilan_id=${kehamilan.id}"),
        ...
        children: [
          ...
          Expanded(
            child: isLoading
                ...
                : catatan.isEmpty
                    ? const Center(child: Text("Belum ada catatan pelayanan trimester 2"))
                    : ListView.builder(
                          ...
                          return InkWell(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => CatatanPelayananT2DetailScreen(data: item),
                                ),
                              );
                            },
                            child: Container(
