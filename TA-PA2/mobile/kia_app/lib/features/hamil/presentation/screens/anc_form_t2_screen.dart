...
import 'package:ta_pa2_pa3_project/features/hamil/presentation/controller/anc_t2_controller.dart';
...
class _AncFormT2ScreenState extends State<AncFormT2Screen> {
  ...
  /// Fungsi Validasi dan Konfirmasi
      ...
      showDialog(
        ...
        builder: (context) => ConfirmationDialog(
          ...
          onConfirm: () {
            ...
            Navigator.pop(context, true); // Kirim sinyal true ke JourneyScreen
          },
        ),
      );
    }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // --- 2. PEMERIKSAAN FISIK & LOGIKA KEMBAR ---
                    _buildSectionCard(
                      ...
                      children: [
                        ...
                        // Switch untuk mengaktifkan mode kembar
                        SwitchListTile(
                        ...
                        // DATA JANIN 2 (Muncul hanya jika Kembar)
  ...
  // --- WIDGET HELPER LAINNYA (Banner, Stats, USG, Skor) ---
