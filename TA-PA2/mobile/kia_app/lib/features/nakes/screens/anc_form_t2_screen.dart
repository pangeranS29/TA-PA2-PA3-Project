...
class AncFormT2Screen extends StatefulWidget {
  ...
  @override
  _AncFormT2ScreenState createState() => _AncFormT2ScreenState();
}
...
class _AncFormT2ScreenState extends State<AncFormT2Screen> {
    ...
    if (_formKey.currentState!.validate()) {
      showDialog(
        ...
        builder: (context) => ConfirmationDialog(
          ...
          content: "Pastikan data fisik, biometri janin, dan skrining preeklampsia sudah benar.",
          primaryColor: color,
          onConfirm: () {
            // Memanggil fungsi submit dari controller
            _controller.submitData(1, context); // Ganti '1' dengan ID kehamilan yang dinamis
          },
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Trimester II — ANC K3", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ...
      // Menggunakan ListenableBuilder agar UI reaktif terhadap perubahan di controller
            ...
            children: [
                          ...
                          children: [
                            ...
                            _buildSectionCard(
                              ...
                              children: [
                                ...
                                _buildCheckItem("Riwayat preeklampsia sebelumnya", _controller.riwayatPreeklampsia, (val) => _controller.riwayatPreeklampsia = val!, "+4"),
                                _buildCheckItem("Kehamilan multiple (kembar)", _controller.isKembar, null, "+4"), // Otomatis dari switch gemelli
                                _buildCheckItem("Diabetes Melitus", _controller.diabetes, (val) => _controller.diabetes = val!, "+4"),
                                
                                const SizedBox(height: 12),
                                _buildRiskHeader("RISIKO SEDANG (SKOR 1)", Colors.orange.shade900),
                                _buildCheckItem("Nullipara", _controller.nullipara, (val) => _controller.nullipara = val!, "+1"),
                                _buildCheckItem("Usia ibu ≥ 35 tahun", _controller.usiaDiatas35, (val) => _controller.usiaDiatas35 = val!, "+1"),
                                _buildCheckItem("MAP > 90 mmHg", _controller.mapDiatas90, (val) => _controller.mapDiatas90 = val!, "+1"),
              ...
              if (_controller.isLoading)
                Container(
                  ...
                  child: const Center(child: CircularProgressIndicator(color: t2Color)),
                ),
            ],
          );
        },
  ...
  // --- WIDGET HELPERS --- (Sama seperti kode asli Anda dengan sedikit penyesuaian)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomInputField(label: "Keterangan Janin (Opsional)", controller: ketCtrl),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Text("Normal", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.green)),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            ...
            onPressed: _controller.isLoading ? null : () => _prosesSimpanT2(color), 
