...
class _ProfilScreenState extends State<ProfilScreen>
  ...
  // ════════════════════════════════════════════════════════════════
  //  RIWAYAT KEHAMILAN — Setiap item = card terpisah yang bisa ditekan
  //  KUNCI: GestureDetector MEMBUNGKUS Container, bukan di dalamnya
  // ════════════════════════════════════════════════════════════════
  ...
  Widget _buildRiwayatKehamilan(List<RiwayatKehamilanSingkat> list) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Header judul (bukan card, cuma label)
        Padding(
        ...
        if (list.isEmpty)
          ...
          ...list.asMap().entries.map((entry) {
            ...
            return Padding(
              ...
              child: _buildRiwayatCard(item, i + 1),
            );
          }),
      ],
    );
  ...
  /// Satu card per kehamilan — GestureDetector di LUAR Container
  Widget _buildRiwayatCard(RiwayatKehamilanSingkat item, int nomor) {
    return MouseRegion(
      cursor: SystemMouseCursors.click, // kursor jadi tangan di web
      child: GestureDetector(
        ...
        // WAJIB opaque supaya area kosong ikut tertangkap
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Baris atas: nomor, judul, status, panah
                Row(children: [
                  CircleAvatar(
                    radius: 12,
